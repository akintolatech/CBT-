"""
Django settings for cbtx project.
...
SECRET_KEY = 'django-insecure-1=o=@%2tx+^tshwexo^d4*-1e6n^)b_%h&qct$%@bl4%!r%r3$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', '192.168.32.79']
...
WSGI_APPLICATION = 'cbtx.wsgi.application'
